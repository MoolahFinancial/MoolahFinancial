...
namespace MoolahFinancialBackend.Models
{
    ...
    using System.Diagnostics; // Added for debugging in console
    ...
    public partial class MoolahEntities : DbContext
    {
        ...
        {
            Database.Log = s => Debug.Print(s); // Added for debugging in console

            // TODO: Figure out whether I should use Lazy Loading or Eager Loading 
